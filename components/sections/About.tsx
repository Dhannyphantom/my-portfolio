                      ...
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center">
                          <div className="w-32 h-32 mx-auto mb-4 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center">
                            <span className="text-6xl font-bold text-white">DO</span>
                          </div>
                          <p className="text-white text-xl font-semibold">Daniel Olojo</p>
                ...
                <div className="relative">
                  ...
                  <div className="relative bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-900 rounded-2xl p-8 shadow-xl">
                    <div className="space-y-6 text-slate-700 dark:text-slate-300 leading-relaxed">
                      <p>
                        I am a <span className="font-semibold text-slate-900 dark:text-white">Pharmacist Intern</span> and{' '}
                        <span className="font-semibold text-slate-900 dark:text-white">Full Stack Developer</span> with a passion for building meaningful digital solutions.
                        My background in pharmacy has trained me to be detail-oriented, analytical, and people-focused—qualities that I bring into every project I develop.
                      </p>

                      <p>
                        I specialize in <span className="font-semibold text-blue-600 dark:text-blue-400">mobile app development with React Native</span> and{' '}
                        <span className="font-semibold text-blue-600 dark:text-blue-400">web development with Next.js and Node.js</span>.
                        Over the years, I've built intuitive applications ranging from e-commerce platforms to educational and spiritual growth tools.
                      </p>

                      <p>
                        Beyond coding, I am also a passionate anime lover (<span className="font-semibold text-slate-900 dark:text-white">dhannyphantom</span>),
                        which influences my creativity and design approach. My goal is to keep bridging the gap between healthcare, technology,
                ...
                <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-2 hover:border-blue-500">
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-xl font-semibold mb-2 text-slate-900 dark:text-white">Healthcare Background</h3>
                        <p className="text-slate-600 dark:text-slate-400">
                          Detail-oriented, analytical, and people-focused approach from pharmaceutical training.
                        </p>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-2 hover:border-cyan-500">
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-xl font-semibold mb-2 text-slate-900 dark:text-white">Technical Expertise</h3>
                        <p className="text-slate-600 dark:text-slate-400">
                          Proficient in React Native, Next.js, Node.js, and modern web technologies.
                        </p>
                      </div>
                    </div>
                  </CardContent>
                ...
                <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-2 hover:border-pink-500">
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-xl font-semibold mb-2 text-slate-900 dark:text-white">Creative Vision</h3>
                        <p className="text-slate-600 dark:text-slate-400">
                          Anime-inspired creativity driving innovative and engaging user experiences.
                        </p>
                      </div>
                    </div>
                  </CardContent>
