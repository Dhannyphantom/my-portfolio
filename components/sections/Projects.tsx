...
const projects = [
  {
    title: "Nigson",
    description:
      "An intuitive e-commerce app designed to enhance the online shopping experience for users in Nigeria.",
    ...
    github: "https://github.com/Dhannyphantom",
    demo: "https://drive.google.com/file/d/1Rm-017mEeftfE5C-cIB6vzs3yHcbCgVY/view?usp=drive_link",
  },
  {
    title: "Guru",
    description:
      "A gamified quiz platform that empowers Nigerian students to learn, excel academically, and earn rewards.",
  ...
  },
  {
    title: "Weebo",
    description:
      "A social media app for anime lovers (weebs/otakus) to connect, share anime news, and engage with the community.",
  ...
  },
  {
    ...
    description:
      "A spiritual growth tracker app that helps users build habits, access Christian podcasts, documentaries, books, and quizzes.",
    ...
    github: "https://github.com/Dhannyphantom",
    demo: "https://drive.google.com/file/d/1c63BsOCt-jOoSEvrkPpqRUqkoTodnZb8/view?usp=drive_link",
  },
];
        ...
        >
          <div className="text-center mb-16">
            ...
            <p className="mt-6 text-xl text-slate-600 dark:text-slate-300 max-w-2xl mx-auto">
              Innovative applications that make a difference in people&apos;s
              lives
            </p>
          </div>
                ...
                >
                  <div className="relative h-48 bg-gradient-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-900 overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div
                        className={`relative ${project.bgColor} p-8 rounded-2xl transform group-hover:scale-110 transition-transform duration-500`}
                      >
